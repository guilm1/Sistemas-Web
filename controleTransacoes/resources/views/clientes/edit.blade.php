...
<div class="jumbotron">
  <p class="form-group">
    Nome:<br>
    <input class="form-control" typer="text" name="nome" value="{{ $cliente->nome}}">
  </p><br><br>

  <p class="form-group"> Identificador: {{ $cliente->id}} </p><br><br>

  <p class="form-group"> Criado em: {{ $cliente->created_at}} </p><br><br>

  <p class="form-group"> Atualizado em: {{ $cliente->uploaded_at}} </p><br><br>
